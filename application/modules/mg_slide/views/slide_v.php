<div class="home-section fullscreen-container" id="home">
    <div class="fullscreenbanner bg-dark">
        <ul>
            <!-- Slide Item -->
            <li data-transition="fade" data-slotamount="7" data-title="Pertama">
                <img src="<?php echo base_url() ?>/assets/images/full/color-1.png" alt="">
            ...
            <!-- End Slide Item -->
            <!-- Slide Item -->
            <li data-transition="fade" data-slotamount="7" data-title="Selanjutnya">

                <img src="<?php echo base_url() ?>/assets/images/full/color-2.png"  alt="">
                   ...
                   <div class="caption customin customout tp-resizeme hs-line-8 no-transp font-alt"
                       ...
                       TEMPAT PERCETAKAN MURAH,CEPAT & BERKUALITAS
